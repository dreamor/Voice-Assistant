...
5. **真正的 Open Interpreter**: 使用官方库，获得完整的电脑控制能力
...
5. **宏命令系统**: 添加 MacroExecutor 支持预设操作序列